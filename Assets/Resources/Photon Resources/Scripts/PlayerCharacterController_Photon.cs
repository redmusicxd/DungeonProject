...
[RequireComponent(typeof(CharacterController), typeof(PlayerInputHandler_Photon), typeof(AudioSource))]
public class PlayerCharacterController_Photon : MonoBehaviour
{
    [Header("References")]
    ...
    public PlayerInputHandler_Photon m_InputHandler;
    public CharacterController m_Controller;
    public PlayerWeaponsManager_Photon m_WeaponsManager;
    Actor m_Actor;
    ...
    void Start()
    {
        ...
        DebugUtility.HandleErrorIfNullGetComponent<CharacterController, PlayerCharacterController_Photon>(m_Controller, this, gameObject);

      //  m_InputHandler = GetComponent<PlayerInputHandler_Photon>();
      //  DebugUtility.HandleErrorIfNullGetComponent<PlayerInputHandler, PlayerCharacterController_Photon>(m_InputHandler, this, gameObject);

     //   m_WeaponsManager = GetComponent<PlayerWeaponsManager_Photon>();
      //  DebugUtility.HandleErrorIfNullGetComponent<PlayerWeaponsManager_Photon, PlayerCharacterController_Photon>(m_WeaponsManager, this, gameObject);

      //  m_Health = GetComponent<Health>();
      //  DebugUtility.HandleErrorIfNullGetComponent<Health, PlayerCharacterController_Photon>(m_Health, this, gameObject);

        m_Actor = GetComponent<Actor>();
        DebugUtility.HandleErrorIfNullGetComponent<Actor, PlayerCharacterController_Photon>(m_Actor, this, gameObject);
        ...
        playerCamera.transform.parent = playerCameraPoint.transform;
        playerCamera.transform.position = playerCameraPoint.position;
        m_WeaponsManager.weaponCamera = weaponCamera;
