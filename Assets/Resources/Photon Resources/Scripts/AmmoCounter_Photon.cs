...
public class AmmoCounter_Photon : MonoBehaviour
{
    ...
    PlayerWeaponsManager_Photon m_PlayerWeaponsManager_Photon;
    WeaponController_Photon m_Weapon;
    ...
    void Update()
    {
        ...
        ammoFillImage.fillAmount = Mathf.Lerp(ammoFillImage.fillAmount, currenFillRatio, Time.deltaTime * ammoFillMovementSharpness);
            ...
            bool isActiveWeapon = m_Weapon == m_PlayerWeaponsManager_Photon.GetActiveWeapon();
