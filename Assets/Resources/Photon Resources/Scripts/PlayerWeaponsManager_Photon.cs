...
[RequireComponent(typeof(PlayerInputHandler_Photon))]
public class PlayerWeaponsManager_Photon : MonoBehaviour
{
    ...
    public List<WeaponController_Photon> startingWeapons = new List<WeaponController_Photon>();


    PlayerWeaponsManager_Photon playerWapMan;
   ...
   [Header("References")]
    ...
    public UnityAction<WeaponController_Photon> onSwitchedToWeapon;
    public UnityAction<WeaponController_Photon, int> onAddedWeapon;
    public UnityAction<WeaponController_Photon, int> onRemovedWeapon;

    WeaponController_Photon[] m_WeaponSlots = new WeaponController_Photon[9]; // 9 available weapon slots
    ...
    public WeaponController_Photon GetActiveWeapon()
    {
        return GetWeaponAtSlotIndex(activeWeaponIndex);
    }

    public WeaponController_Photon GetWeaponAtSlotIndex(int index)
    {
