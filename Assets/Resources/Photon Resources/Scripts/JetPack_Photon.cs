...
public class JetPack_Photon : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        DebugUtility.HandleErrorIfNullGetComponent<PlayerCharacterController_Photon, Jetpack>(m_PlayerCharacterController, this, gameObject);

        m_InputHandler = GetComponent<PlayerInputHandler_Photon>();
        DebugUtility.HandleErrorIfNullGetComponent<PlayerInputHandler_Photon, Jetpack>(m_InputHandler, this, gameObject);
    ...
    void Update()
    {
        ...
        else { jetpackVfx.SetActive(false); }
