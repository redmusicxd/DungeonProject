...
public class WeaponController_Photon : Photon.Pun.MonoBehaviourPun
{

    ProjectileStandard_Photon test;
    [Header("Information")]
    ...
    public ProjectileStandard_Photon projectilePrefab;
    ...
    [HideInInspector]
    public PlayerWeaponsManager_Photon atribuire;
