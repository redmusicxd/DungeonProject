...
public class PlayerInputHandler_Photon : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        DebugUtility.HandleErrorIfNullGetComponent<PlayerCharacterController_Photon, PlayerInputHandler_Photon>(m_PlayerCharacterController, this, gameObject);
        m_GameFlowManager = FindObjectOfType<GameFlowManager_Photon>();
        DebugUtility.HandleErrorIfNullFindObject<GameFlowManager_Photon, PlayerInputHandler_Photon>(m_GameFlowManager, this);
