...
public class ProjectileStandard_Photon : MonoBehaviour
{
    [Header("General")]
    public PlayerWeaponsManager_Photon playerWeaponsManager;
    ...
    private void OnEnable()
    {
        ...
        DebugUtility.HandleErrorIfNullGetComponent<ProjectileBase, ProjectileStandard_Photon>(m_ProjectileBase, this, gameObject);
    ...
    void OnShoot()
    {
      ...
      //  PlayerWeaponsManager_Photon playerWeaponsManager = m_ProjectileBase.owner.GetComponent<PlayerWeaponsManager_Photon>();
