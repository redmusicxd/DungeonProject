...
public class Pickup : MonoBehaviour
{
    ...
    public UnityAction<PlayerCharacterController_Photon> onPick_Photon;
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (Online)
        {
            PlayerCharacterController_Photon pickingPlayer_Photon = other.GetComponent<PlayerCharacterController_Photon>();

            if (pickingPlayer_Photon != null)
            {
                if (onPick_Photon != null)
                {
                    onPick_Photon.Invoke(pickingPlayer_Photon);
                    PickUP = true;
                }
            }
        }
